package com.example.app.scanner.devices.floatingCamera
...
import com.example.app.scanner.Scanner
import com.example.app.ui.utils.scaleImageView.ScaleImage
import com.example.app.ui.utils.screen.Screen
import com.example.app.ui.utils.snackbar.MakeText.Companion.makeText
import com.example.app.ui.utils.snackbar.SnackBarType
import com.example.app.ui.utils.snackbar.SnackBarType.CREATOR.ERROR
...
class FloatingCameraBarcode(private var activity: AppCompatActivity) : BarcodeCallback,
    ...
    private fun loadValues() {
        ...
        portraitLoc = intArrayOf(settingsVm.portraitLocX, settingsVm.portraitLocY)
        portraitWidth = min(settingsVm.portraitWidth, screenWidth)
        portraitHeight = min(settingsVm.portraitHeight, screenHeight)
        landscapeLoc = intArrayOf(settingsVm.landscapeLocX, settingsVm.landscapeLocY)
        landscapeWidth = min(settingsVm.landscapeWidth, screenWidth)
        landscapeHeight = min(settingsVm.landscapeHeight, screenHeight)

        continuousOn = settingsVm.continuousOn
        filterRepeatedReads = settingsVm.filterRepeatedReads
    }
    ...
    private fun saveValues() {
        ...
        settingsVm.portraitLocX = portraitLoc[0]
        settingsVm.portraitLocY = portraitLoc[1]
        settingsVm.portraitWidth = portraitWidth
        settingsVm.portraitHeight = portraitHeight
        settingsVm.landscapeLocX = landscapeLoc[0]
        settingsVm.landscapeLocY = landscapeLoc[1]
        settingsVm.landscapeWidth = landscapeWidth
        settingsVm.landscapeHeight = landscapeHeight
        settingsVm.continuousOn = continuousOn
        settingsVm.filterRepeatedReads = filterRepeatedReads
    }
