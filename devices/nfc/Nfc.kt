package com.example.app.scanner.devices.nfc
...
import com.example.app.ui.utils.ParcelUtils.parcelable
import com.example.app.R
import com.example.app.MyApp.Companion.context
import com.example.app.ui.activities.barcode.ItemBarcodeActivity
import com.example.app.ui.activities.inventory.InventoryAuditActivity
import com.example.app.ui.activities.item.ItemSelectActivity
import com.example.app.ui.activities.movement.WmDeliveryActivity
import com.example.app.ui.activities.movement.WmInternalActivity
import com.example.app.ui.activities.movement.WmReceptionActivity
import com.example.app.ui.activities.order.OrderModifyActivity
import com.example.app.ui.activities.order.OrderPackagingActivity
import com.example.app.ui.activities.packaging.PackagingActivity
import com.example.app.ui.activities.qualityControl.QualityControlActivity
import com.example.app.ui.activities.wac.WacSelectActivity
import com.example.app.ui.activities.wmr.WmrActivity
...
object Nfc {
    ...
    fun nfcHandleIntent(intent: Intent, targetActivity: AppCompatActivity?) {
        ...
        if (NfcAdapter.ACTION_TECH_DISCOVERED == action) {
            ...
            when (targetActivity) {
                is InventoryAuditActivity -> targetActivity.scannerCompleted(id)
                is ItemBarcodeActivity -> targetActivity.scannerCompleted(id)
                is ItemSelectActivity -> targetActivity.scannerCompleted(id)
                is OrderModifyActivity -> targetActivity.scannerCompleted(id)
                is OrderPackagingActivity -> targetActivity.scannerCompleted(id)
                is PackagingActivity -> targetActivity.scannerCompleted(id)
                is QualityControlActivity -> targetActivity.scannerCompleted(id)
                is WacSelectActivity -> targetActivity.scannerCompleted(id)
                is WmDeliveryActivity -> targetActivity.scannerCompleted(id)
                is WmInternalActivity -> targetActivity.scannerCompleted(id)
                is WmReceptionActivity -> targetActivity.scannerCompleted(id)
                is WmrActivity -> targetActivity.scannerCompleted(id)
            }
        }
    }
