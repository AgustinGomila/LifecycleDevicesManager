package com.example.app.scanner.devices.honeywell
...
class Honeywell(private val activity: AppCompatActivity) : Scanner() {
    ...
    internal object Constants {
         ...
         */
        const val ACTION_BARCODE_DATA = "com.example.app.intent.action.BARCODE"
         ...
         * Settings / Scan Settings / Internal Scanner / + / Select an application / MyApp
         */
        const val appProfile = "MyApp"
    ...
    private fun loadProperties() {
        ...
        val sendDigit = settingsVm.sendCheckDigit
    ...
    private fun resumeScanner(): Boolean {
        ...
        try {
            ...
            val intent = Intent(Constants.ACTION_CLAIM_SCANNER).putExtra(
                ...
                /*
                We are using "MyApp", so a profile with this name has to be created in Scanner settings:
