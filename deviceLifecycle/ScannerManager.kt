package com.example.app.scanner.deviceLifecycle
...
import com.example.app.data.enums.collector.RfidType
import com.example.app.data.enums.error.ErrorLog
import com.example.app.scanner.Collector
import com.example.app.scanner.Collector.Companion.collectorType
import com.example.app.scanner.Collector.Companion.collectorTypeChanged
import com.example.app.scanner.Collector.Companion.isNfcRequired
import com.example.app.scanner.Scanner
import com.example.app.scanner.Scanner.ScannerListener
import com.example.app.scanner.devices.floatingCamera.FloatingCameraBarcode
import com.example.app.scanner.devices.nfc.Nfc
import com.example.app.scanner.devices.nfc.Nfc.enableNfcForegroundDispatch
import com.example.app.scanner.devices.rfid.Rfid
import com.example.app.scanner.devices.rfid.Rfid.Companion.appHasBluetoothPermission
import com.example.app.scanner.devices.rfid.Rfid.Companion.isRfidRequired
...
import com.example.app.ui.utils.snackbar.SnackBarType.CREATOR.INFO
...
object ScannerManager : DeviceLifecycle.Listener {
     ...
     * LifecycleOwner com.example.app.xxx.xxxActivity@cf72429
